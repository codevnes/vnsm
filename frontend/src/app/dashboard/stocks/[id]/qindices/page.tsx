...
interface StockQIndicesPageProps {
  params: {
    id: string;
  };
}

const StockQIndicesPage = ({ params }: StockQIndicesPageProps) => {
  // Unwrap params using React.use()
  const unwrappedParams = React.use(params as unknown as Promise<StockQIndicesPageProps['params']>);
  const stockId = unwrappedParams.id as string;
...
export default StockQIndicesPage;