...
interface DeleteEpsRecordDialogProps {
    record: EpsRecord | null; // The record being deleted
    isOpen: boolean;
...
export const DeleteEpsRecordDialog: React.FC<DeleteEpsRecordDialogProps> = ({
    record,
    isOpen,
    onOpenChange,
    onConfirm,
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        This action cannot be undone. This will permanently delete the EPS record for
